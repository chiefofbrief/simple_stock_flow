...
*Execute after Metrics. Driven entirely by flags raised in Metrics — not a predetermined list. `{TICKER}_notes.md` and `{TICKER}_mda.md` are never read in full — only matched lines enter context.*
