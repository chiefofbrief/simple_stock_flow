"""
SpaceNews RSS Feed Fetcher
==========================

Fetches and displays the latest space industry, business, and policy news 
from SpaceNews.

Usage:
    python spacenews.py                       # Last 24 hours/same day (default)
    python spacenews.py --days 0              # Today only
    python spacenews.py --markdown             # Output for Peter's Digest
"""
...
def filter_articles(articles, days, target_date=None):
    ...
    # WordPress uses: "Wed, 08 Apr 2026 14:31:45 +0000"
...
def main():
    ...
    if args.markdown:
        print(f"## SpaceNews - Industry & Policy")
        if not articles:
        ...
        console = Console()
        console.print(Panel(Text("SpaceNews", style="bold white on black"), border_style="bright_blue"))
        for art in articles:
