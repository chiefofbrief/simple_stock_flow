#!/usr/bin/env python3
"""
Wall Street Journal News Fetcher (via Perigon)
===============================================

Fetches the most recent WSJ articles from the last 24 hours via Perigon API.

Usage:
    python "new scripts for digest/wsj.py" [--count 50]
...
def fetch_wsj(api_key, count=DEFAULT_COUNT):
...
def main():
    ...
    articles = fetch_wsj(api_key, args.count)
