...
TSM is one of the highest-quality and most positively-covered businesses among the AI-chip leaders, yet it's priced below weaker rivals on the cash it actually generates — heavy fab spending explains part of that, and the rest is most likely a discount for sitting on Taiwan. It isn't cheap (it still carries a full ~36x earnings multiple); the real question is whether the market is missing earnings power that doesn't show up in today's numbers.

**The numbers.** TSM grades near the top of the group — second on operating margin (53%), third on return on capital (~49%), second on growth, and the only name whose earnings need no cleanup to compare. Yet measured on the cash the business produces, it's priced *below* ASML, Broadcom, and KLA, all of which earn less, on thinner margins, growing slower. Part of that is fair: TSM spends ~31% of revenue building factories and keeps only ~46% of its operating cash as free cash (the asset-light peers keep 80–97%), so a dollar of its profit turns into less spendable cash — and that spending bites further in the near term, with margins set to dip as 2nm and the overseas fabs ramp before the 3nm crossover helps. But heavy spending still doesn't explain why TSM is priced under companies that are worse on nearly every measure. The most likely reason for that leftover gap is geopolitics — the discount the market applies to a company whose fabs sit on Taiwan, a real tail risk that can't be hedged away and is the price of admission here, not a footnote. (We did not analyze that risk; we are naming it as the leftover, not measuring it.)

**The narrative.** This isn't the usual case where something priced low is also disliked. TSM has the most one-sided bullish coverage in the group — 98% of analysts positive, not a single sell or underweight, confident management, demand ahead of supply into 2027. For contrast: Broadcom's last report triggered a selloff, Amkor's story is speculative, ASML carries China and layoff overhangs, KLA a valuation caution; only Nvidia is hyped to a similar degree, and more loudly. So the low relative pricing sits on top of a glowing story, not a broken one. The flip side: when everyone is already this bullish, there's little room for a good surprise and a lot of room for a drop if any crack widens — the obvious candidate being customers moving work to Samsung or Intel, though even those chips still get packaged at TSM.

**Does it have underappreciated earnings power?** This is where it gets interesting, because three things sit outside how the business is currently modeled:
- **TSM deliberately under-charges.** Its most successful node ever (3nm) still earns below the company average in its third year, and management's posture is "never disturb a customer who is busy buying." There is pricing it has chosen not to take.
- **It may control the real bottleneck in AI — packaging.** The scarce, priciest step in an AI chip is the packaging (CoWoS) that bonds the logic to its memory, and Nvidia plus all five hyperscalers' custom chips route through TSM for it. That could be a large hidden business — but it's unproven: TSM doesn't break it out, its disclosed figures don't yet show packaging out-growing wafers, a cheaper glass-substrate rival (Powertech's PiFO, ~30% less) is emerging, and TSM's own US packaging won't run at volume until 2028. A credible theory, not a sure thing.
- **Robotics/physical AI runs through TSM too.** Its fastest-growing segment this quarter (IoT, +59% year-on-year, off a small base) is a faint early hint, yet TSM doesn't even name robotics as a driver while Nvidia builds its next chapter around it.
...
|---|---|---|---|---|---|---|
| GAAP P/E | 30.8x | 21.2x* **(-31%)** | 50.2x* (+63%) | 56.2x (+82%) | 64.9x (+111%) | 64.3x* (+108%) |
| Non-GAAP P/E | 31.0x | 27.4x (-12%) | 40.3x (+30%) | 55.8x (+80%) | 63.5x* (+105%) | 65.5x* (+112%) |
| Price / Owner Earnings | 46.8x | 26.6x **(-43%)** | 57.2x (+22%) | NM | 144.8x (+209%) | NM* |
| ROIC | 57.6%* | 119.8%* **(+108%)** | 30.1%* (-48%) | 70.8%* **(+23%)** | 49.5% (-14%) | 7.9%* (-86%) |
| Operating margin | 58.0%* | 65.6% (+13%) | 49.0% (-15%) | 36.0% (-38%) | 41.2% (-29%) | 6.0%* (-90%) |
| Revenue | $144.0B | $326.5B* **(+127%)** | $88.7B* (-38%) | $40.7B* (-72%) | $13.7B (-91%) | $6.7B* (-95%) |
| OCF | $92.9B | $201.4B **(+117%)** | $42.0B (-55%) | $-10.2B* (NM) | $2.8B* (-97%) | $0.6B (-99%) |
| FCF | $47.9B* | $194.3B **(+306%)** | $41.0B* (-14%) | $-12.1B* (NM) | $2.5B* (-95%) | $-0.3B* (NM) |
| Capex | $45.0B | $7.0B (-84%) | $0.9B (-98%) | $2.0B (-96%) | $0.3B (-99%) | $0.9B* (-98%) |
| Capex / Revenue | 31.2% | 2.2% **(-93%)** | 1.0% **(-97%)** | 4.8% **(-85%)** | 2.5% **(-92%)** | 13.3% **(-57%)** |
| FCF / OCF | 51.6%* | 96.5% **(+87%)** | 97.8%* **(+90%)** | 119.3% **(+131%)** | 88.0%* **(+71%)** | -54.8%* (NM) |

## Section 2 — TTM (trailing four quarters)

| Metric | TSM | NVDA | AVGO | ASML | KLAC | AMKR |
|---|---|---|---|---|---|---|
| GAAP P/E | 36.5x | 31.1x* (-15%) | 63.8x* (+75%) | 61.9x (+70%) | 66.8x (+83%) | 49.1x* (+35%) |
| Non-GAAP P/E | 35.9x | 35.0x (-2%) | 48.3x (+35%) | 67.2x (+87%) | NM* | 49.4x* (+38%) |
| Price / Owner Earnings | 64.1x | 44.2x **(-31%)** | 78.0x (+22%) | 73.4x (+15%) | 83.9x (+31%) | 128.1x* (+100%) |
| ROIC | 48.6%* | 82.0%* **(+69%)** | 24.2%* (-50%) | 64.3%* **(+32%)** | 48.3% (-1%) | 10.1%* (-79%) |
| Operating margin | 53.2%* | 64.0% **(+20%)** | 43.7% (-18%) | 34.8% (-35%) | 42.1% (-21%) | 7.6%* (-86%) |
| Revenue | $130.6B | $253.5B* **(+94%)** | $75.5B* (-42%) | $39.1B* (-70%) | $13.1B (-90%) | $7.1B* (-95%) |
| OCF | $76.1B | $125.6B **(+65%)** | $33.6B (-56%) | $12.5B (-84%) | $4.4B* (-94%) | $1.2B (-98%) |
| FCF | $35.0B* | $119.1B **(+240%)** | $32.8B* (-6%) | $9.9B (-72%) | $4.0B* (-89%) | $0.2B* (-100%) |
| Capex | $41.1B | $6.6B (-84%) | $0.9B (-98%) | $2.5B (-94%) | $0.4B (-99%) | $1.0B* (-97%) |
| Capex / Revenue | 31.5% | 2.6% **(-92%)** | 1.1% **(-96%)** | 6.4% **(-80%)** | 3.0% **(-91%)** | 14.8% **(-53%)** |
| FCF / OCF | 46.0%* | 94.8% **(+106%)** | 97.4%* **(+112%)** | 79.8% **(+74%)** | 91.2%* **(+98%)** | 13.7%* (-70%) |

## Section 3 — Last 3 Fiscal Years (USD)

### TSM  (FY ends Dec)

| Metric | FY2025 | FY2024 | FY2023 | 3yr CAGR | Δ CAGR vs TSM |
|---|---|---|---|---|---|
| GAAP P/E | 28.5x | 27.4x | 19.4x | — | — |
| Price / Owner Earnings | 45.0x | 36.5x | 57.8x | — | — |
| ROIC* | 47.0% | 36.5% | 29.3% | 4.9% | — |
| Operating margin* | 50.8% | 45.7% | 42.6% | 0.9% | — |
| Revenue | $122.2B | $91.9B | $68.6B | 19.3% | — |
| OCF | $75.7B | $58.0B | $39.4B | 14.0% | — |
| FCF* | $34.8B | $27.6B | $9.1B | 28.2% | — |
| Capex | $40.8B | $30.4B | $30.3B | 5.7% | — |
| Capex / Revenue | 33.4% | 33.0% | 44.2% | -11.5% | — |
| FCF / OCF* | 46.1% | 47.6% | 23.1% | 12.5% | — |

### NVDA  (FY ends Jan)

| Metric | FY2026 | FY2025 | FY2024 | 3yr CAGR | Δ CAGR vs TSM |
|---|---|---|---|---|---|
| GAAP P/E | 37.8x | 47.3x | 49.6x | — | — |
| Price / Owner Earnings | 50.3x | 61.5x | 62.9x | — | — |
| ROIC* | 76.1% | 90.2% | 64.1% | 71.4% | **+67pp** |
| Operating margin | 60.4% | 62.4% | 54.1% | 56.8% | **+56pp** |
| Revenue | $215.9B | $130.5B | $60.9B | 100.0% | **+81pp** |
| OCF | $102.7B | $64.1B | $28.1B | 163.1% | **+149pp** |
| FCF | $96.7B | $60.9B | $27.0B | 193.9% | **+166pp** |
| Capex | $6.0B | $3.2B | $1.1B | 48.8% | +43pp |
| Capex / Revenue | 2.8% | 2.5% | 1.8% | -25.6% | -14pp |
| FCF / OCF | 94.1% | 95.0% | 96.2% | 11.7% | -1pp |

### AVGO  (FY ends Nov)

| Metric | FY2025 | FY2024 | FY2023 | 3yr CAGR | Δ CAGR vs TSM |
|---|---|---|---|---|---|
| GAAP P/E | 75.7x | 134.5x | 27.5x | — | — |
| Price / Owner Earnings | 90.5x | 58.0x | 25.1x | — | — |
| ROIC* | 20.3% | 6.6% | 31.5% | -8.0% | -13pp |
| Operating margin* | 39.9% | 26.1% | 45.2% | -2.4% | -3pp |
| Revenue* | $63.9B | $51.6B | $35.8B | 24.4% | +5pp |
| OCF | $27.5B | $20.0B | $18.1B | 18.1% | +4pp |
| FCF* | $26.9B | $19.4B | $17.6B | 18.2% | -10pp |
| Capex | $0.6B | $0.5B | $0.5B | 13.7% | +8pp |
| Capex / Revenue | 1.0% | 1.1% | 1.3% | -8.6% | +3pp |
...
| ROIC* | 102.2% | 71.8% | 70.2% | 2.3% | -3pp |
| Operating margin | 34.6% | 31.9% | 32.8% | 4.1% | +3pp |
| Revenue | $37.9B | $32.8B | $32.0B | 15.6% | -4pp |
| OCF | $14.1B | $13.5B | $6.2B | 13.6% | -0pp |
| FCF | $12.4B | $11.0B | $3.8B | 14.8% | -13pp |
| Capex | $1.8B | $2.5B | $2.5B | 6.5% | +1pp |
| Capex / Revenue | 4.6% | 7.6% | 7.7% | -7.8% | +4pp |
...
| ROIC | 49.7% | 36.9% | 51.8% | -1.9% | -7pp |
| Operating margin | 43.1% | 37.1% | 38.1% | 2.8% | +2pp |
| Revenue | $12.2B | $9.8B | $10.5B | 9.7% | -10pp |
| OCF | $4.1B | $3.3B | $3.7B | 7.2% | -7pp |
| FCF | $3.7B | $3.0B | $3.3B | 7.6% | -21pp |
| Capex | $0.3B | $0.3B | $0.3B | 3.4% | -2pp |
| Capex / Revenue | 2.8% | 2.8% | 3.3% | -5.7% | +6pp |
| FCF / OCF | 91.7% | 91.6% | 90.7% | 0.3% | -12pp |

### AMKR  (FY ends Dec)

| Metric | FY2025 | FY2024 | FY2023 | 3yr CAGR | Δ CAGR vs TSM |
|---|---|---|---|---|---|
| GAAP P/E | 26.1x | 17.7x | 22.0x | — | — |
| Price / Owner Earnings | 51.1x | 19.2x | 15.4x | — | — |
| ROIC* | 9.3% | 9.0% | 9.5% | -20.9% | -26pp |
| Operating margin* | 7.0% | 6.9% | 7.2% | -18.0% | -19pp |
| Revenue* | $6.7B | $6.3B | $6.5B | -1.8% | -21pp |
| OCF | $1.1B | $1.1B | $1.3B | -0.1% | -14pp |
| FCF* | $0.2B | $0.3B | $0.5B | 0.1% | -28pp |
| Capex* | $0.9B | $0.7B | $0.7B | -0.1% | -6pp |
| Capex / Revenue | 13.5% | 11.8% | 11.5% | 1.7% | +13pp |
| FCF / OCF* | 17.4% | 31.7% | 41.0% | 0.2% | -12pp |
...
- **Currency:** all figures USD. FX [ESTIMATED, FMP spot 2026-06-18]: EUR/USD 1.16128, USD/TWD 31.496. Ratios (P/E, ROIC, margins, Capex/Rev, FCF/OCF) are currency-neutral.
- **% gap:** each peer cell shows (peer - TSM) / |TSM|. **Bold** = peer beats TSM by >= 20% (snapshot) or 20pp (CAGR). "Beats" = lower for P/E, P/Owner Earnings, Capex, Capex/Revenue; higher for ROIC, Operating margin, Revenue, OCF, FCF, FCF/OCF.
